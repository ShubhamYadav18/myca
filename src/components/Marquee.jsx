...
function Marquee() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed=".1" className='w-full py-20 rounded-tl-3xl rounded-tr-3xl bg-[#2C3E50]'>
        <div className='text border-t-2 border-b-2 border-[#475A6E] flex overflow-hidden whitespace-nowrap'>
